...
const Add = ({token}) => {
      ...
      const onSubmitHandler = async(e)=>{
        ...
        try {
          ...
          //  image1&& type operation for mandate to upload image only when image is available.
      ...
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            {/* adding turnery operator concept in imag src to see the image in place of upload after uploading the image */}
